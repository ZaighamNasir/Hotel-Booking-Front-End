...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='max-w-6xl mt-8 w-full text-gray-800'>
        ...
        {bookings.map((booking)=>(
          <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
            ...
            {/* ------ Payment Status ----- */}
            <div className='flex flex-col items-starts justify-center pt-3'>
              ...
              {!booking.isPaid && (
                <button className='px-4 py-1.5 mt-4 ttext-xs border border-gray-400 rounded-full hover-bg-gray-50 transition-all cursor-pointer'>Pay Now</button>
              )}
            </div>
          </div>
        ))}

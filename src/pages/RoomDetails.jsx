...
const RoomDetails = () => {
  ...
  return  room && (
    <div className='py-28 md:py-35 md:px-16 lg:px-24 xl:px-32'>
      ...
      {/* Room Rating */}
      <div className='flex items-center gapp-1 mt-2'>
        <StarRating />
        ...
        <div className='flex flex-col flex-wrap md:flex-row items-start d:items-center gap-4 md:gap-10 text-gray-500'>
            ...
            <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
             <div className='flex flex-col'>
                ...
                <input type="number" id='guests' placeholder='0' className='max-w-20 rounded border border-fray-300 px-3 py-2 mt-1.5 outline-none' required/>
            </div>
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to availability.You get a comfortable Two bedroom apartment has true city feeling. The price quoted is for two guests, at the guest slot please mark the number of guests to get the exact price for groups. The Guests will be allocated on the ground floor according to availability.You get a comfortable Two bedroom apartment has true city feeling.</p>
      </div>

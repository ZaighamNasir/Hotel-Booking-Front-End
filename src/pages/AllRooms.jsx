...
const AllRooms = () => {
    ...
    const [openFilters, setOpenFilters] = useState(false) /* FOr the show and hide on the filters part */
      ...
      <div>
        ...
        {roomsDummyData.map((room)=>(
            <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last-border-0'>
                <img onClick={()=> {navigate(`/rooms/${room._id}`); scrollTo(0,0)}} src={room.images[0]} alt="hotel-img" title='View Room Details' className='max-h-65 md:w-1/2 rounded-x1 shadow-lg object-cover cursor-pointer'/>
      ...
      <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16'>
        ...
        <div className={`flex items-center justify-between px-5 py-2.5 min-lg:border-b border-gray-300 ${openFilters && "border-b"}`}>
            ...
            <div className='text-xs cursor-pointer'>
                <span onClick={()=> setOpenFilters(!opennFilters)} className='lg:hidden'>
